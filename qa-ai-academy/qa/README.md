...
Done means: All 18 missions are structurally checked, sequential completion and
...
- First-run state has 18 missions, Mission 01 available, and later missions
  locked.
...
- All missions unlock and complete sequentially, award five points exactly
  once, reach 90 points, and persist after reload.
- Thirteen optional advanced modules preserve the six-part learning structure,
...
```text
Changed: Reconciled the suite with the expanded curriculum (18 missions, 13
advanced modules, content version 14, 90-point campaign) and added coverage for
the mutation, schema-contract, and flaky-triage optional labs.
Verified: `npm test` passed all 31 scenarios on 2026-08-20, covering the
complete 18-mission progression, all thirteen Advanced modules, expanded
persistence/accessibility/layout checks, and every optional-lab starting failure
and isolated repair path.
...
Not changed: Mission content, save-key names, and the Story/Direct presentation
choice.
